...
#define FRAME_BRIGHTNESS_THRESHOLD_HIGH  60.0 // High hysteresis % of pixels in a frame, that are above BRIGHTNESS_THRESHOLD for it to be considered a bright frame
