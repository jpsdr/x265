...
template<int shift>
static inline void partialButterfly16_neon(const int16_t *src, int16_t *dst, intptr_t srcStride)
{
    const int line = 16;

    const int32x4_t c0 = vld1q_s32(t8_even[0]);
    const int32x4_t c4 = vld1q_s32(t8_even[1]);
    const int32x4_t c8 = vld1q_s32(t8_even[2]);
    const int32x4_t c12 = vld1q_s32(t8_even[3]);
    ...
    for (int i = 0; i < line; i += 4)
    {
        ...
        int32x4_t t1 = vrev64q_s32(vcombine_s32(vget_high_s32(ee0),
                                                vget_high_s32(ee1)));
        int32x4_t t2 = vcombine_s32(vget_low_s32(ee2), vget_low_s32(ee3));
        int32x4_t t3 = vrev64q_s32(vcombine_s32(vget_high_s32(ee2),
                                                vget_high_s32(ee3)));
        ...
        for (int k = 1; k < 16; k += 2)
        {
            ...
            const int16x4_t c_lo = vget_low_s16(c);
            const int16x4_t c_hi = vget_high_s16(c);

            int32x4_t tt0 = vmull_s16(c_lo, vget_low_s16(o0));
            int32x4_t tt1 = vmull_s16(c_lo, vget_low_s16(o1));
            int32x4_t tt2 = vmull_s16(c_lo, vget_low_s16(o2));
            int32x4_t tt3 = vmull_s16(c_lo, vget_low_s16(o3));
            tt0 = vmlal_s16(tt0, c_hi, vget_high_s16(o0));
            tt1 = vmlal_s16(tt1, c_hi, vget_high_s16(o1));
            tt2 = vmlal_s16(tt2, c_hi, vget_high_s16(o2));
            tt3 = vmlal_s16(tt3, c_hi, vget_high_s16(o3));
        ...
        int16x4_t res0 = vrshrn_n_s32(vmulq_s32(c0, sum), shift);
        vst1_s16(dst + 0 * line, res0);

        int16x4_t res4 = vrshrn_n_s32(vpaddq_s32(vmulq_s32(c4, eeo0),
                                                 vmulq_s32(c4, eeo1)), shift);
        vst1_s16(dst + 4 * line, res4);

        int16x4_t res8 = vrshrn_n_s32(vpaddq_s32(vmulq_s32(c8, eee0),
                                                 vmulq_s32(c8, eee1)), shift);
        vst1_s16(dst + 8 * line, res8);

        int16x4_t res12 = vrshrn_n_s32(vpaddq_s32(vmulq_s32(c12, eeo0),
                                                  vmulq_s32(c12, eeo1)), shift);
...
template<int shift>
static inline void partialButterfly32_neon(const int16_t *src, int16_t *dst, intptr_t srcStride)
{
    const int line = 32;
    ...
    for (int i = 0; i < line; i += 4)
    {
        ...
        {
            const int16x8_t c0_c1 = vld1q_s16(&g_t32[k][0]);
            const int16x8_t c2_c3 = vld1q_s16(&g_t32[k][8]);
            const int16x4_t c0_o = vget_low_s16(c0_c1);
            const int16x4_t c1_o = vget_high_s16(c0_c1);
            const int16x4_t c2_o = vget_low_s16(c2_c3);
            const int16x4_t c3_o = vget_high_s16(c2_c3);

            int32x4_t tt0 = vmull_s16(c0_o, vget_low_s16(o00));
            int32x4_t tt1 = vmull_s16(c0_o, vget_low_s16(o10));
            int32x4_t tt2 = vmull_s16(c0_o, vget_low_s16(o20));
            int32x4_t tt3 = vmull_s16(c0_o, vget_low_s16(o30));
            tt0 = vmlal_s16(tt0, c1_o, vget_high_s16(o00));
            tt1 = vmlal_s16(tt1, c1_o, vget_high_s16(o10));
            tt2 = vmlal_s16(tt2, c1_o, vget_high_s16(o20));
            tt3 = vmlal_s16(tt3, c1_o, vget_high_s16(o30));
            tt0 = vmlal_s16(tt0, c2_o, vget_low_s16(o01));
            tt1 = vmlal_s16(tt1, c2_o, vget_low_s16(o11));
            tt2 = vmlal_s16(tt2, c2_o, vget_low_s16(o21));
            tt3 = vmlal_s16(tt3, c2_o, vget_low_s16(o31));
            tt0 = vmlal_s16(tt0, c3_o, vget_high_s16(o01));
            tt1 = vmlal_s16(tt1, c3_o, vget_high_s16(o11));
            tt2 = vmlal_s16(tt2, c3_o, vget_high_s16(o21));
            tt3 = vmlal_s16(tt3, c3_o, vget_high_s16(o31));

            int32x4_t t0123 = vpaddq_s32(vpaddq_s32(tt0, tt1),
                                         vpaddq_s32(tt2, tt3));
            int16x4_t res = vrshrn_n_s32(t0123, shift);
            vst1_s16(dst + k * line, res);
        }

        in0 = vld1q_s16_x4(src + (i + 0) * srcStride);
        in1 = vld1q_s16_x4(src + (i + 1) * srcStride);
        in2 = vld1q_s16_x4(src + (i + 2) * srcStride);
        in3 = vld1q_s16_x4(src + (i + 3) * srcStride);
        ...
        {
            const int32x4_t c0_eo = vld1q_s32(&t32_eo_s32[(k / 4) * 8]);
            const int32x4_t c1_eo = vld1q_s32(&t32_eo_s32[(k / 4) * 8 + 4]);

            int32x4_t tt0 = vmulq_s32(c0_eo, eo00);
            int32x4_t tt1 = vmulq_s32(c0_eo, eo10);
            int32x4_t tt2 = vmulq_s32(c0_eo, eo20);
            int32x4_t tt3 = vmulq_s32(c0_eo, eo30);
            tt0 = vmlaq_s32(tt0, c1_eo, eo01);
            tt1 = vmlaq_s32(tt1, c1_eo, eo11);
            tt2 = vmlaq_s32(tt2, c1_eo, eo21);
            tt3 = vmlaq_s32(tt3, c1_eo, eo31);
...
void dct16_neon(const int16_t *src, int16_t *dst, intptr_t srcStride)
{
    ...
    partialButterfly16_neon<shift_pass1>(src, coef, srcStride);
    partialButterfly16_neon<shift_pass2>(coef, dst, 16);
}
...
void dct32_neon(const int16_t *src, int16_t *dst, intptr_t srcStride)
{
    ...
    partialButterfly32_neon<shift_pass1>(src, coef, srcStride);
    partialButterfly32_neon<shift_pass2>(coef, dst, 32);
}
